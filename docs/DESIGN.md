...
> Design notes for **fieldservice-kb-bot** — a runnable typescript example that Typed field-service knowledge bot for work-order follow-up.
...
- **Feature code** — the actual task: field-service knowledge bot.
